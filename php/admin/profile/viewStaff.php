...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    mysqli_query($connect, "DELETE FROM `staff` WHERE staffID=$id");
    unset($_GET['delete']);
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mx-0 row" bis_skin_checked="1">
                                            ...
                                            <div class="col-sm-12 col-md-6" bis_skin_checked="1">
                                                <div class="dt-action-buttons text-right" bis_skin_checked="1"><a href="addStaff.php"><button class="dt-button create-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-toggle="modal" data-target="#modals-slide-in"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus mr-50 font-small-4">
                                                                ...
                                                                </svg>Register New Staff</span></button></a>
                                                </div>
                                            </div>
                                        </div>
                                        <table class="datatables-basic table dataTable no-footer dtr-column" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1205px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 134px;" aria-label="Email: activate to sort column ascending">Staff ID</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 180px;" aria-label="Date: activate to sort column ascending">Staff Name</th>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 230px;" aria-label="Status: activate to sort column ascending">Speciality</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><?php echo $user_info['staffID']; ?></td>
                                                            <td><?php echo $user_info['staffName']; ?></td>
                                                            <td><?php echo $user_info['gender']; ?></td>
                                                            <td><?php echo $user_info['email']; ?></td>
                                                            <td><?php echo $user_info['contact']; ?></td>
                                                            <td><?php echo $user_info['speciality']; ?></td>
                                                            <td><a href="editStaff.php?edit=<?php echo $user_info['staffID']; ?>">
                                                                    <button class="btn-primary">Edit</button></a>
                                                                <a href="viewStaff.php?delete=<?php echo $user_info['staffID']; ?>">
