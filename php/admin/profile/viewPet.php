...
<div class="app-content content ">
    ...
    <div class="content-wrapper">
        ...
        <td>  " . $owner . "</td>
        <td>  " . $weight . "</td>
        <td>" . "<a  href='updatePet.php?edit=".$row["petID"] . "'<span class='btn-sm btn-outline-primary waves-effect material-icons-outlined'></span> Edit</a>" . "
               <a  href='viewPet.php?delete=".$row["petID"] . "'<span class='btn-sm btn-danger waves-effect material-icons-outlined'></span> Delete</a>" . "
        </td>";
