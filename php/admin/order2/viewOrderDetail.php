...
if (isset($_GET['edit'])) {
    $result2 = mysqli_query($connect, "SELECT MAX(`orderID`) as `id` FROM `order`")
        or die($mysqli->error);
    ...
    $result3 = mysqli_query($connect, "SELECT * FROM `supplier` WHERE supplierID='$supplier'");
...
$result2 = mysqli_query($connect, "SELECT * FROM inventory")
    or die($mysqli->error);
                            ...
                            <div class="card invoice-preview-card">
                                ...
                                <div class="card-body invoice-padding pb-0">
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                        <div>
                                            <p class="card-text mb-25"><?php echo $address; ?></p>
                                            <p class="card-text mb-25"><?php echo $contactNo; ?></p>
                                        </div>
                                        <div class="invoice-number-date mt-md-0 mt-2">
                                            <div class="d-flex align-items-center justify-content-md-end mb-1">
                                                <h4 class="invoice-title">Purchase Order: <?php echo $orderID; ?></h4>

                                            </div>
                                            <div class="d-flex align-items-center mb-1">
                                                <span class="title">Purchase Date: <?php echo $orderDate; ?></span>
                                ...
                                <div class="card-body invoice-padding">
                                    <div class="row invoice-sales-total-wrapper">
                                        <div class="col-md-6 order-md-1 order-2 mt-md-0 mt-3">
                                            <div class="d-flex align-items-center mb-1">
                                                <label for="salesperson" class="form-label">Person in charge:</label>
...
It was a pleasure working with you and your team. We hope you will keep us in mind for future freelance projects. Thank You!</textarea>
                        ...
                        <div class="col-xl-3 col-md-4 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <button class="btn btn-primary btn-block mb-75" disabled>Print Purchase Order</button>
                                    <a href="addOrder.php" class="btn btn-outline-primary btn-block mb-75">Back</a>
                                </div>
                            </div>
                        </div>
