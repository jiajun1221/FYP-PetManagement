...
if (isset($_POST['submit'])) {
    ...
    $media = $_POST['mediaID'];
    mysqli_query($connect, "INSERT INTO product(productID,productName,productType,price,quantity,mediaID) VALUES('$productID','$productName','$productType','$price','$quantity','$mediaID')")
        or die($mysqli->error);
}
?>
