...
<div class="app-content content ">
    ...
    <div class="content-wrapper">
        ...
        <td>  " . $time . "</td>
        <td>  " . "RM" . $price . "</td>
        <td>" . "<a  href='editService.php? ID=" . $row["serviceID"] . "'<span class='material-icons-outlined'></span> Edit</a>" . "
               <a  href='viewService.php? ID=" . $row["serviceID"] . "'<span class='material-icons-outlined'></span> Delete</a>" . "
        </td>";

                                                            // <td>"."<a  href='product_view.php? ID=".$row["serviceID "] ."'<span class='material-icons-outlined'></span> View</a>"."</td>";
