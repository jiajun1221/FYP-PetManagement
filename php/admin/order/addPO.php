        ...
        <section class="form-control-repeater">
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body " id="test"><br>
                  ...
                  <form method="POST" action="b.addPO.php" class="form-inline" name="myPO">
                        ...
                        <div class="col-sm">
                          ...
                          <div class="card shadow mb-4">
                            <div class="card-body">
                              ...
                              <div class="row">
                                <a id="add_row" style="color:#82e6f1; padding:10px" class="btn btn-flat-info toggle waves-effect">Add Row</a>
                              ...
                              <div class="row clearfix" style="margin-top:20px; margin-left: 70% ">
                                <div class="pull-right col-md-9">
                                  <table class="table table-bordered table-hover" id="tab_logic_total">
                                    <tbody>
                                      <tr>
                                        <th class="text-center sub" style="min-width: 100px; background-color: #00cfe8; color: white;">Sub Total</th>
                                      ...
                                      <tr>
                                        <th class="text-center sub " style="min-width: 100px; background-color: #00cfe8; color: white;">Tax</th>
                                      ...
                                      <tr>
                                        <th class="text-center sub" style="min-width: 100px; background-color: #00cfe8; color: white;">Tax Amount</th>
            ...
            <td class="text-center"><input type="number" name='total_ammount' id="total_amount" placeholder='0.00' class="form-control" readonly name="grand_total" /></td>
                                      ...
                                      <tr>
                                        <th class="text-center sub" style="min-width: 100px; background-color: #00cfe8; color: white;">Grand Total</th>
