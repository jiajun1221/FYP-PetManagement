            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Make Delivery Order</h4>
                </div>
                <div class="card-body " id="test"><br>

                  <form method="POST" action="b.addDO.php" class="form-inline" name="myDO" onsubmit="return validateForm()">
                    <div class="container-fluid">
                      <div class="row">
                        <div class="col-sm">
                          <h4>Delivery Order</h4><br>
