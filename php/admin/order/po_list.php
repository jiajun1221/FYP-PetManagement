                                ...
                                <div class="card">
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mx-0 row" bis_skin_checked="1">
                                            ...
                                            <div class="col-sm-12 col-md-6" bis_skin_checked="1">
                                                <div class="dt-action-buttons text-right" bis_skin_checked="1"><a href="addPO.php"><button class="dt-button create-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-toggle="modal" data-target="#modals-slide-in"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus mr-50 font-small-4">
                                                                    <line x1="12" y1="5" x2="12" y2="19"></line>
                                                                    <line x1="5" y1="12" x2="19" y2="12"></line>
                                                                </svg>Create Purchase Order</span></button></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="content-header-center col-12">
                                            <table class="table table-bordered" id="do_table">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql = "SELECT * FROM `purchase_order` WHERE `status` = 1 ORDER BY `purchase_order`.`ID` DESC";
									...
									<td>";
                                                    ...
                                                    ?><span class="badge badge-pill badge-secondary mr-1">Processing</span> <?php
                                                                                                                        ...
                                                                                                                        ?><span class="badge badge-pill badge-info mr-1">Preparing</span> <?php
                                                                                                                                                                                                ...
                                                                                                                                                                                                echo "</td>
									<td><a class='text-white btn btn-primary' style='text-decoration: none;' href='view_po.php?ID=" . $row["ID"] . "'>View</a>
									</td>";
                                                                                                                                                                                                echo "</tr>";
                                                                                                                                                                                                # code...
                                                                                                                                                                                            }
