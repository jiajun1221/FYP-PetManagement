                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="account-name" name="name" placeholder="Name" value="<?php echo $userName ?>">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                ...
                                                <div class=" col-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly type="text" class="form-control" id="account-company" name="company" placeholder="Company name" value="petcare Film Automative">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <button type="logout" style="float:right;" class="btn btn-outline-secondary mt-2 waves-effect"><a href="../authentication/userlogin.php">Log Out</button></a>
                                                </div>
                                            </div>
                                        </form>
                                        <!--/ form -->
