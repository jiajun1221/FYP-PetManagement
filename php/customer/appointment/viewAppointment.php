                                        ...
                                        <table class="datatables-basic table dataTable no-footer dtr-column" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1205px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 90px;">Staff ID</th>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 140px;">Status</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php if ($current_status_type == '0') { ?><span class="badge badge-pill badge-light-success mr-1">Completed</span> <?php } else if ($current_status_type == '1') { ?><span class="badge badge-pill badge-light-warning mr-1">Pending</span> <?php } ?></td>
                                                            <td><a href="editAppointment.php?edit=<?php echo $user_info['appointmentID']; ?>">
