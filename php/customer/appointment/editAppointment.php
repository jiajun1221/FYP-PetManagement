                                ...
                                <form class="form form-horizontal" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                <div class="col-sm-3 col-form-label">
                                                    <label for="appointmentDate">Purchase Date</label>
                                                </div>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                <div class="col-sm-3 col-form-label">
                                                    <label for="appointmentTime">Service Date</label>
                                                </div>
                                                <div class="col-sm-9">
                                                    <input name="appointmentTime" id="datefield" type='date' min='1899-01-01' max='2000-13-13'></input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                <div class="col-sm-3 col-form-label">
                                                    <label for="serviceType">Install Date</label>
                                                </div>
                                                <div class="col-sm-9">
                                                    <input name="serviceType" id="datefield" type='date' min='1899-01-01' max='2000-13-13'></input>
                                                </div>
                                            </div>
                                        </div>
