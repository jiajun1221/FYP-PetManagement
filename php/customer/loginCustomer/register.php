    ...
    <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        ...
        <form class="auth-register-form mt-2" action="register.php" method="POST">
            <div class="form-group">
                ...
                <input class="form-control" id="register-username" type="text" name="userName" placeholder="riken" aria-describedby="register-username" autofocus="" tabindex="1" />
            </div>
            <div class="form-group">
                <label class="form-label" for="register-email">Email</label>
                <input class="form-control" id="register-email" type="text" name="userEmail" placeholder="riken@example.com" aria-describedby="register-email" tabindex="2" />
            </div>
            <div class="form-group">
